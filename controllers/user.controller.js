...
//     try {
//         const { name, email, password, phone, district, role } = request.body; // Capture phone and district

//         if (!name || !email || !password || !phone || !district) {
//             return response.status(400).json({
//                 message: "Please provide name, email, password, phone, and district",
//                 error: true,
//                 success: false,
//             });
//         }
...
//  response.cookie('refreshToken',accesstoken,cookiesOption)
